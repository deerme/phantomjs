...
protected:
    ...
    static const unsigned StructureFlags = JSC::OverridesVisitChildren | JSC::OverridesGetOwnPropertySlot | JSC::InterceptsGetOwnPropertySlotByIndexEvenWhenLengthIsNotZero | JSC::ImplementsHasInstance | JSC::OverridesGetPropertyNames | JSC::HasImpureGetOwnPropertySlot | Base::StructureFlags;
};
